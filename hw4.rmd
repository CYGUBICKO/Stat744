...
- We fit both generalised linear model and Cox PH model inoder to evaluate the prognostic factors associated with survival of Wims Tumor patient.
	- We model linear effect of year, hence treat it as quantitative variable.
...
extract_coefs_df <- (map(list(logistic = logistic_model, coxph = coxph_model), tidy, conf.int = TRUE)
	%>% bind_rows(.id = "model")
